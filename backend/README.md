...
## Project Structure
    ...
    ├── testaddconnector_de_34437  # Django project configurations
...
1. Clone this repo and `cd testaddconnector_de_34437`
...
2. Clone this repo and `cd testaddconnector_de_34437`
